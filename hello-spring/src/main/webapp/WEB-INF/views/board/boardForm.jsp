...
$(() => {
	$("[name=upFile]").change(e => {
		//파일명 가져오기
		var file = $(e.target).prop('files')[0]; //현재 선택한 파일
		//input:file 이 multiple속성일 경우 번지수를 바꾸면 파일명 여러개 출력 가능
		
		console.log(file);
		var $label = $(e.target).next(); //형제요소

		//label에 파일명 적용 (custom-file-label)
		//file이 존재하면 true, undefined는 false
